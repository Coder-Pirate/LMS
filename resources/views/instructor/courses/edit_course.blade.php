    ...
    <div class="card">
        <div class="card-body p-4">
            ...
            <div class="form-group col-md-12">
                ...
                <textarea name="prerequisites" class="form-control" id="input11" placeholder="Address ..." rows="3">{{$course->prerequisites  }}</textarea>
            </div>
            <div class="form-group col-md-12">
                <label for="input1" class="form-label">Course Description </label>
                <textarea name="description" class="form-control" id="editor">{!! $course->description !!}</textarea>
            </div>
