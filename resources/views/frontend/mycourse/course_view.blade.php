...
@endphp
            <div class="card">
                <div class="card-header" id="mobileCourseHeadingOne{{ $sec->id }}">
                    <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#mobileCourseCollapseOne{{ $sec->id }}" aria-expanded="true" aria-controls="mobileCourseCollapseOne">
                ...
                <div id="mobileCourseCollapseOne{{ $sec->id }}" class="collapse" aria-labelledby="mobileCourseHeadingOne{{ $sec->id }}" data-parent="#mobileCourseAccordionCourseExample">
